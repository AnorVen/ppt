...
export const base_themes = {
	base_them_1: 'ВВЕДЕНИЕ В ППТ. АКТУАЛЬНЫЙ КОНФЛИКТ И ТЕКУЩАЯ ЖИЗНЕННАЯ СИТУАЦИЯ',
	base_them_2: 'ОСНОВНЫЕ КОНЦЕПЦИИ КОНФЛИКТОВ И СЕМЬИ',
	base_them_3: 'ПОЗИТИВНАЯ ПСИХОДИНАМИКА',
	base_them_4: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
	base_them_5: 'ТЕРАПЕВТИЧЕСКИЕ ОТНОШЕНИЯ И ВЗАИМОДЕЙСТВИЕ',
};

export const master_themes = {
	master_them_1: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
	master_them_2: 'ПСИХОДИНАМИКА в ППТ',
	master_them_3: 'ПСИХОДИНАМИЧЕСКИЙ СЕТТИНГ И ВЗАИМООТНОШЕНИЯ в ППТ',
	master_them_4: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
	master_them_5: 'ПСИХОДИНАМИЧЕСКИЙ ПРОЦЕСС в ППТ',
	master_them_6: 'ПЕРВОЕ ИНТЕРВЬЮ в формате ППТ',
	master_them_7: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
	master_them_8: 'ПЛАНИРОВАНИЕ ТЕРАПИИ и ИНТЕРВЕНЦИЙ в ППT',
	master_them_9: 'ПСИХИЧЕСКИЕ РАССТРОЙСТВА (ЧАСТЬ 1)',
	master_them_10: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
	master_them_11: 'ПСИХИЧЕСКИЕ РАССТРОЙСТВА (ЧАСТЬ II)',
	master_them_12: 'ЛИЧНОСТЬ, ХАРАКТЕР И ТРАВМА',
	master_them_13: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
	master_them_14: 'САЛЮТОГЕНЕЗ, ПСИХОСОМАТИКА, РАССТРОЙСТВА, СВЯЗАННЫЕ СО СТРЕССОМ',
	master_them_15: 'МЕЖЛИЧНОСТНЫЕ КОНФЛИКТЫ. СЕМЕЙНАЯ И СУПРУЖЕСКАЯ ТЕРАПИЯ',
	master_them_16: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
	master_them_17: 'ПРИМЕНЕНИЕ ПОЗИТИВНОЙ ПСИХОТЕРАПИИ',
	master_them_18: 'САМОПОЗНАНИЕ/САМОРАСКРЫТИЕ',
};
